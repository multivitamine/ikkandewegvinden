...
function Personas() {
    ...
    useEffect(() => {
        ...
        client.getEntry('68mc45TkrAK86mtQ6mE0WK').then((response) => {
            setIntro(response.fields);
        });
        client.getEntry('CdmbCs4OZFlCwNU7LUclh').then((response) => {
            setFooter(response.fields);
        });
        client.getEntry('4lMhd6mEoI16Oj4zpFo4jb').then((response) => {
    ...
    return (
        <div>
            ...
            <main>
                ...
                {personas.length && <TextContainer theme={'gray'} item={footer} />}
